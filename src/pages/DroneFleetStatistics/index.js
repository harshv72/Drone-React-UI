...
const DroneFleetStatisticsPage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-inter items-center justify-start mx-[auto] lg:pb-[258px] xl:pb-[323px] 2xl:pb-[364px] 3xl:pb-[437px] w-[100%]">
        <Column className="justify-start w-[100%]">
          ...
          <Row className="font-poppins items-start ml-[3px] w-[73%]">
            ...
            <div className="lg:mt-[35px] xl:mt-[44px] 2xl:mt-[50px] 3xl:mt-[60px] overflow-x-auto w-[71%]">
              <Column className="justify-start w-[100%]">
                ...
                <Column className="font-poppins justify-start mt-[4px] w-[100%]">
                  ...
                  <Column className="font-manrope justify-end lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] lg:pt-[24px] xl:pt-[31px] 2xl:pt-[35px] 3xl:pt-[42px] w-[100%]">
                    ...
                    <Column className="bg-white_A700 font-dmsans items-center justify-start lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] rounded-radius14 w-[78%]">
                      <Column className="items-center justify-start lg:mb-[21px] xl:mb-[26px] 2xl:mb-[30px] 3xl:mb-[36px] mt-[3px] w-[98%]">
                        <Stack className="lg:h-[127px] xl:h-[159px] 2xl:h-[179px] 3xl:h-[214px] w-[99%]">
                          <Stack className="absolute lg:h-[127px] xl:h-[159px] 2xl:h-[179px] 3xl:h-[214px] w-[100%]">
                            <Stack className="absolute lg:h-[127px] xl:h-[159px] 2xl:h-[179px] 3xl:h-[214px] w-[100%]">
                              <Img
                                ...
                                alt="FrameFortyEight"
                              />
                              <div className="absolute bg-gradient2  lg:h-[124px] xl:h-[154px] 2xl:h-[174px] 3xl:h-[208px] inset-y-[0] left-[44%] my-[auto] rounded-radius10 w-[7%]"></div>
                            </Stack>
                            <Column
                          ...
                          <Column className="absolute justify-start right-[31%] top-[9%] w-[14%]">
                            <Text
...
export default DroneFleetStatisticsPage;
