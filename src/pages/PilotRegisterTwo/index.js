...
const PilotRegisterTwoPage = () => {
  const navigate = useNavigate();

  function handleNavigate180() {
    navigate("/pilotregisterfive");
  }
  ...
  return (
    <>
      <Column className="bg-white_A700 font-inter items-center justify-start mx-[auto] lg:pb-[34px] xl:pb-[43px] 2xl:pb-[49px] 3xl:pb-[58px] w-[100%]">
        <Column className="justify-start w-[100%]">
              ...
              <Column className="items-center justify-start lg:mt-[56px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] w-[100%]">
                ...
                <Column className="border border-gray_301 border-solid font-poppins justify-start lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] lg:p-[22px] xl:p-[28px] 2xl:p-[32px] 3xl:p-[38px] rounded-radius8 w-[100%]">
                  ...
                  <Row className="items-center justify-between lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[100%]">
                    ...
                    <List
                      className="lg:gap-[22px] xl:gap-[28px] 2xl:gap-[32px] 3xl:gap-[38px] grid grid-cols-2 min-h-[auto] w-[65%]"
                ...
                <Column className="bg-gray_101 border border-dashed border-gray_600 font-poppins items-center justify-end lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] lg:p-[11px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius9 w-[100%]">
                  <Img
                    ...
                    className="lg:h-[17px] xl:h-[21px] 2xl:h-[24px] 3xl:h-[28px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] w-[4%]"
                    alt="camera"
                  />
          ...
          <Row className="items-center justify-center lg:ml-[235px] xl:ml-[294px] 2xl:ml-[331px] 3xl:ml-[397px] lg:mt-[44px] xl:mt-[55px] 2xl:mt-[62px] 3xl:mt-[74px] w-[52%]">
            <Button
...
export default PilotRegisterTwoPage;
