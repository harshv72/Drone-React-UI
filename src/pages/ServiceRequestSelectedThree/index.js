...
const ServiceRequestSelectedThreePage = () => {
  const navigate = useNavigate();

  function handleNavigate61() {
    navigate("/servicerequestselectedtwo");
  }
    ...
    <>
      <Column className="bg-white_A700 font-inter justify-start mx-[auto] lg:pb-[18px] xl:pb-[23px] 2xl:pb-[26px] 3xl:pb-[31px] w-[100%]">
        ...
        <Column className="justify-start lg:ml-[161px] xl:ml-[202px] 2xl:ml-[227px] 3xl:ml-[273px] lg:mt-[25px] xl:mt-[31px] 2xl:mt-[35px] 3xl:mt-[42px] w-[59%]">
          ...
          <Column className="items-center justify-start lg:mt-[10px] xl:mt-[13px] 2xl:mt-[14px] 3xl:mt-[17px] w-[38%]">
            <Text
              className="font-light text-bluegray_900 w-[auto]"
              variant="body5"
            >
              Enter details to find correct information{" "}
            </Text>
          </Column>
          <Stack className="lg:h-[353px] xl:h-[441px] 2xl:h-[496px] 3xl:h-[595px] w-[100%]">
            ...
            <Column className="absolute border border-gray_301 border-solid bottom-[0] font-poppins justify-start lg:p-[20px] xl:p-[25px] 2xl:p-[28px] 3xl:p-[33px] right-[0] rounded-radius8 w-[100%]">
              ...
              <Column className="justify-start lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] w-[100%]">
                ...
                <Line className="bg-gray_301 h-[1px] lg:mt-[31px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] w-[100%]" />
              </Column>
              <Column className="justify-start lg:mb-[33px] xl:mb-[41px] 2xl:mb-[46px] 3xl:mb-[56px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] w-[100%]">
                <Text className="Field" variant="body5">
                  Price of Service
                </Text>
                <Line className="bg-gray_301 h-[1px] lg:mt-[32px] xl:mt-[40px] 2xl:mt-[45px] 3xl:mt-[55px] w-[100%]" />
...
export default ServiceRequestSelectedThreePage;
