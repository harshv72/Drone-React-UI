...
const CloudAdminSearchScheThreePage = () => {
              ...
              <Stack className="font-dmsans xl:h-[1137px] 2xl:h-[1279px] 3xl:h-[1535px] lg:h-[909px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[100%]">
                ...
                <Stack className="absolute bottom-[0] font-poppins 2xl:h-[1029px] 3xl:h-[1235px] lg:h-[732px] xl:h-[915px] w-[100%]">
                  <Stack className="absolute 2xl:h-[1029px] 3xl:h-[1235px] lg:h-[732px] xl:h-[915px] w-[100%]">
                    <Stack className="absolute 2xl:h-[1029px] 3xl:h-[1235px] lg:h-[732px] xl:h-[915px] w-[100%]">
                      <Column className="absolute items-center justify-start w-[100%]">
                        <Row className="items-start justify-between w-[100%]">
                          ...
                          <Column
                            className="bg-cover bg-repeat justify-start lg:pl-[51px] xl:pl-[64px] 2xl:pl-[73px] 3xl:pl-[87px] lg:py-[51px] xl:py-[64px] 2xl:py-[73px] 3xl:py-[87px] w-[63%]"
                            style={{
                              backgroundImage: "url('images/img_group581.png')",
                            }}
                          >
                            <Column className="bg-white_A700 border border-bluegray_101 border-solid items-center justify-end lg:ml-[375px] xl:ml-[469px] 2xl:ml-[528px] 3xl:ml-[633px] py-[4px] rounded-radius2 w-[5%]">
                              <Img
                            ...
                            <Stack className="lg:h-[470px] xl:h-[588px] 2xl:h-[661px] 3xl:h-[793px] lg:mb-[100px] xl:mb-[125px] 2xl:mb-[141px] 3xl:mb-[169px] lg:ml-[148px] xl:ml-[185px] 2xl:ml-[209px] 3xl:ml-[250px] lg:mt-[4px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] w-[68%]">
                              <Column
                                className="absolute bg-cover bg-repeat items-end justify-start left-[3%] lg:p-[107px] xl:p-[134px] 2xl:p-[151px] 3xl:p-[181px] w-[97%]"
                                style={{
                                  backgroundImage:
                              ...
                              <Column
                                className="absolute bg-cover bg-repeat h-[max-content] inset-[0] items-end justify-center m-[auto] lg:p-[18px] xl:p-[23px] 2xl:p-[26px] 3xl:p-[31px] w-[97%]"
                                style={{
                                  backgroundImage:
                      ...
                      <Column className="absolute items-center justify-start left-[0] top-[21%] w-[35%]">
                        <Line className="bg-gray_203 h-[1px] w-[90%]" />
                        <Stack className="lg:h-[186px] xl:h-[233px] 2xl:h-[262px] 3xl:h-[314px] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
                    ...
                    <Column className="absolute font-dmsans justify-start left-[1%] top-[5%] w-[39%]">
                      <Text className="columnstationeddrone" variant="body5">
                        2 Bookings Found in Region
                      </Text>
                      <List
                        className="gap-[0] min-h-[auto] lg:ml-[102px] xl:ml-[128px] 2xl:ml-[144px] 3xl:ml-[172px] lg:mt-[36px] xl:mt-[46px] 2xl:mt-[52px] 3xl:mt-[62px] w-[68%]"
                        orientation="vertical"
                      >
                        <Stack
                          className="bg-cover bg-repeat lg:h-[37px] xl:h-[46px] 2xl:h-[52px] 3xl:h-[62px] ml-[3px] lg:my-[33px] xl:my-[41px] 2xl:my-[47px] 3xl:my-[56px] rounded-radius15 shadow-bs6 w-[99%]"
                          style={{
                        ...
                        <Stack
                          className="bg-cover bg-repeat lg:h-[37px] xl:h-[46px] 2xl:h-[52px] 3xl:h-[62px] mr-[3px] lg:my-[33px] xl:my-[41px] 2xl:my-[47px] 3xl:my-[56px] rounded-radius15 shadow-bs6 w-[99%]"
                          style={{
                            backgroundImage: "url('images/defaultNoData.png')",
                          }}
                        >
                  ...
                  <Column className="absolute justify-start left-[20%] top-[14%] w-[4%]">
                    <Img
                      ...
                      className="lg:h-[32px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[53px] ml-[3px] rounded-radius50 w-[94%]"
                      alt="EllipseOne"
                    />
                    <Img
                      src="images/img_ellipse1_147X149.png"
                      className="lg:h-[32px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[53px] 2xl:mt-[101px] 3xl:mt-[121px] lg:mt-[71px] xl:mt-[89px] rounded-radius50 w-[94%]"
                      alt="EllipseOne One"
                    />
                  </Column>
                </Stack>
...
export default CloudAdminSearchScheThreePage;
