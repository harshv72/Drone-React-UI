            ...
            <Column className="font-inter justify-start lg:mt-[24px] xl:mt-[30px] 2xl:mt-[34px] 3xl:mt-[40px] w-[79%]">
              ...
              <Stack className="font-dmsans xl:h-[1137px] 2xl:h-[1279px] 3xl:h-[1535px] lg:h-[909px] lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[100%]">
                ...
                <Stack className="absolute bottom-[0] font-poppins 2xl:h-[1029px] 3xl:h-[1235px] lg:h-[732px] xl:h-[915px] w-[100%]">
                  <Stack className="absolute 2xl:h-[1029px] 3xl:h-[1235px] lg:h-[732px] xl:h-[915px] w-[100%]">
                    <Stack className="absolute 2xl:h-[1029px] 3xl:h-[1235px] lg:h-[732px] xl:h-[915px] w-[100%]">
                      <Stack className="absolute 2xl:h-[1029px] 3xl:h-[1235px] lg:h-[732px] xl:h-[915px] w-[100%]">
                        <Column className="absolute items-center justify-start left-[0] w-[100%]">
                          <Row className="items-start justify-between w-[100%]">
                            ...
                            >
                              <Column className="absolute inset-x-[0] justify-start mx-[auto] top-[5%] w-[97%]">
                                <Stack className="lg:h-[554px] xl:h-[693px] 2xl:h-[779px] 3xl:h-[935px] w-[100%]">
                                  <Stack className="absolute lg:h-[554px] xl:h-[693px] 2xl:h-[779px] 3xl:h-[935px] w-[100%]">
                                    ...
                                    <Column
                                      className="absolute bg-cover bg-repeat justify-start left-[0] lg:p-[39px] xl:p-[48px] 2xl:p-[55px] 3xl:p-[66px] top-[1%] w-[39%]"
                                      style={{
                                        backgroundImage:
                                          "url('images/img_group567.svg')",
                                      }}
                                    >
                                      <Row className="items-start mb-[4px] lg:mt-[50px] xl:mt-[63px] 2xl:mt-[71px] 3xl:mt-[85px] w-[87%]">
                                        <Column className="bg-gradient6  3xl:h-[101px] lg:h-[60px] xl:h-[75px] 2xl:h-[85px] items-center justify-start 2xl:mt-[10px] 3xl:mt-[12px] lg:mt-[7px] xl:mt-[8px] xl:px-[10px] 2xl:px-[12px] 3xl:px-[14px] lg:px-[8px] rounded-radius50 3xl:w-[100px] lg:w-[59px] xl:w-[74px] 2xl:w-[84px]">
                                          <Text
                                            className="Services"
                                            variant="body12"
                                          >
                                        ...
                                        <Column className="bg-green_50_99 lg:h-[28px] xl:h-[34px] 2xl:h-[39px] 3xl:h-[46px] items-center justify-start lg:ml-[12px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] xl:px-[10px] 2xl:px-[12px] 3xl:px-[14px] lg:px-[8px] rounded-radius50 lg:w-[27px] xl:w-[33px] 2xl:w-[38px] 3xl:w-[45px]">
                                  ...
                                  <Column className="absolute justify-start right-[2%] top-[6%] w-[90%]">
                                    ...
                                    >
                                      <Column className="justify-start lg:mb-[102px] xl:mb-[128px] 2xl:mb-[144px] 3xl:mb-[172px] 3xl:mt-[105px] lg:mt-[62px] xl:mt-[78px] 2xl:mt-[88px] w-[81%]">
                                        <Stack className="bg-white_A700 lg:h-[54px] xl:h-[67px] 2xl:h-[76px] 3xl:h-[91px] lg:ml-[34px] xl:ml-[43px] 2xl:ml-[49px] 3xl:ml-[58px] lg:px-[10px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] rounded-radius12 shadow-bs5 w-[84%]">
                                        ...
                                        <Column className="bg-gradient6  3xl:h-[101px] lg:h-[60px] xl:h-[75px] 2xl:h-[85px] items-center justify-start lg:mt-[21px] xl:mt-[26px] 2xl:mt-[30px] 3xl:mt-[36px] xl:px-[10px] 2xl:px-[12px] 3xl:px-[14px] lg:px-[8px] rounded-radius50 3xl:w-[100px] lg:w-[59px] xl:w-[74px] 2xl:w-[84px]">
                                          <Text
                                            className="Services"
                                            variant="body12"
                                          >
                              ...
                              <Column
                                className="absolute bg-cover bg-repeat bottom-[0] justify-end left-[14%] lg:p-[17px] xl:p-[21px] 2xl:p-[24px] 3xl:p-[28px] w-[38%]"
                                style={{
                                  backgroundImage:
                        ...
                        <Column className="absolute items-center justify-start left-[0] top-[23%] w-[36%]">
                      ...
                      <Column className="absolute font-dmsans justify-start left-[1%] top-[5%] w-[40%]">
                        <Column className="justify-start w-[100%]">
                          <Text
                            className="columnstationeddrone"
                            variant="body5"
                          >
                            4 Bookings Found in Region
                          </Text>
                          <List
                            className="gap-[0] min-h-[auto] lg:ml-[101px] xl:ml-[127px] 2xl:ml-[143px] 3xl:ml-[171px] lg:mt-[36px] xl:mt-[46px] 2xl:mt-[52px] 3xl:mt-[62px] w-[68%]"
                            orientation="vertical"
                          >
                            ...
                            <Stack
                              className="bg-cover bg-repeat lg:h-[37px] xl:h-[46px] 2xl:h-[52px] 3xl:h-[62px] mx-[auto] lg:my-[32px] xl:my-[40px] 2xl:my-[45px] 3xl:my-[54px] rounded-radius15 shadow-bs6 w-[99%]"
                              style={{
                                backgroundImage:
                                  "url('images/defaultNoData.png')",
                              }}
                        ...
                        <Column className="items-center justify-start lg:mt-[43px] xl:mt-[54px] 2xl:mt-[61px] 3xl:mt-[73px] w-[89%]">
                          <Column className="bg-white_A700 border-2 border-deep_purple_A400 border-solid items-center justify-end lg:p-[12px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] rounded-radius12 shadow-bs5 w-[100%]">
                            <Column className="justify-start 3xl:mt-[10px] lg:mt-[6px] xl:mt-[8px] 2xl:mt-[9px] w-[95%]">
                              <Row className="font-poppins items-end justify-between w-[100%]">
                                <Column className="justify-start w-[22%]">
                    ...
                    <Stack
                      className="absolute bg-cover bg-repeat bottom-[41%] lg:h-[37px] xl:h-[46px] 2xl:h-[52px] 3xl:h-[62px] left-[13%] rounded-radius15 shadow-bs6 w-[26%]"
                      style={{
                  ...
                  <Column className="absolute justify-start left-[20%] top-[14%] w-[5%]">
                    <Img
                      src="images/img_ellipse1_147X149.png"
                      className="lg:h-[32px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[53px] ml-[1px] rounded-radius50 w-[79%]"
                      alt="EllipseOne"
                    />
                    <Img
                      src="images/img_ellipse1.png"
                      className="lg:h-[36px] xl:h-[45px] 2xl:h-[51px] 3xl:h-[61px] 2xl:mt-[105px] 3xl:mt-[126px] lg:mt-[74px] xl:mt-[93px] rounded-radius25 w-[81%]"
                      alt="EllipseThree"
                    />
                    <Img
                      src="images/img_ellipse1_147X149.png"
                      className="lg:h-[32px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[53px] ml-[3px] 3xl:mt-[108px] lg:mt-[64px] xl:mt-[80px] 2xl:mt-[90px] rounded-radius50 w-[79%]"
                      alt="EllipseOne One"
                    />
                    <Img
                      src="images/img_ellipse1_147X149.png"
                      className="lg:h-[32px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[53px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] 3xl:mt-[115px] lg:mt-[68px] xl:mt-[85px] 2xl:mt-[96px] rounded-radius50 w-[79%]"
                      alt="EllipseOne Two"
                    />
                  </Column>
                </Stack>
...
export default DRAFTCloudAdminBooPage;
