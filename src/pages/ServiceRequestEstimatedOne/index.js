...
const ServiceRequestEstimatedOnePage = () => {
  const navigate = useNavigate();

  function handleNavigate155() {
    navigate("/finishedbookingdatac");
  }
    ...
    <>
      ...
      >
        <Column className="justify-start w-[100%]">
          ...
          <Column className="justify-start lg:ml-[183px] xl:ml-[229px] 2xl:ml-[258px] 3xl:ml-[309px] lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[69%]">
            <Img
            ...
            <Stack className="lg:h-[406px] xl:h-[508px] 2xl:h-[571px] 3xl:h-[685px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[16px] lg:mt-[9px] w-[100%]">
              <Stack className="absolute font-inter lg:h-[406px] xl:h-[508px] 2xl:h-[571px] 3xl:h-[685px] left-[0] w-[90%]">
                ...
                <Column className="absolute bg-white_A700 bottom-[0] font-worksans inset-x-[0] items-center justify-start mx-[auto] lg:p-[5px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] rounded-bl-[0] rounded-br-[0] rounded-tl-[40px] rounded-tr-[40px] w-[98%]">
                  <Column className="justify-start lg:mb-[24px] xl:mb-[31px] 2xl:mb-[35px] 3xl:mb-[42px] w-[100%]">
                    <Row className="items-end w-[100%]">
                      <Column className="justify-start lg:mb-[10px] xl:mb-[13px] 2xl:mb-[15px] 3xl:mb-[18px] w-[17%]">
                        <Text
                          className="font-semibold 2xl:ml-[11px] 3xl:ml-[13px] lg:ml-[7px] xl:ml-[9px] text-gray_800 w-[auto]"
                          variant="body6"
                        >
                          Summary
                        </Text>
                        <Stack className="lg:h-[57px] xl:h-[71px] 2xl:h-[80px] 3xl:h-[95px] xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[15px] lg:mt-[9px] w-[100%]">
                      ...
                      <Column className="justify-start lg:mt-[20px] xl:mt-[25px] 2xl:mt-[29px] 3xl:mt-[34px] w-[37%]">
                        ...
                        <Row className="items-start lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[100%]">
                          ...
                          <Text className="rowlocation" variant="body12">
                            3671 Old Toll Road, Mariposa, CA 95338 West Plot A:
                            Crop
                          </Text>
                        </Row>
                      ...
                      <Column className="bg-white_A700 border border-gray_300 border-solid items-center justify-start lg:mb-[11px] xl:mb-[14px] 2xl:mb-[16px] 3xl:mb-[19px] 2xl:ml-[104px] 3xl:ml-[124px] lg:ml-[73px] xl:ml-[92px] lg:mt-[23px] xl:mt-[29px] 2xl:mt-[33px] 3xl:mt-[39px] p-[3px] rounded-radius6 w-[14%]">
                        <Img
                      ...
                      <Column className="justify-start lg:mb-[14px] xl:mb-[18px] 2xl:mb-[21px] 3xl:mb-[25px] lg:ml-[5px] xl:ml-[7px] 2xl:ml-[8px] 3xl:ml-[9px] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[18%]">
                        <Text
                    ...
                    <Column className="bg-gray_202 justify-start lg:mt-[12px] xl:mt-[16px] 2xl:mt-[18px] 3xl:mt-[21px] 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] rounded-radius10 w-[94%]">
            ...
            <Row className="items-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[84%]">
              <Button
...
export default ServiceRequestEstimatedOnePage;
