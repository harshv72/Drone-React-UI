...
const AdminSimulatedCloudDPage = () => {
      ...
      <Column className="bg-white_A700 font-inter items-center justify-start mx-[auto] lg:pb-[108px] xl:pb-[135px] 2xl:pb-[152px] 3xl:pb-[182px] w-[100%]">
        <Column className="justify-start w-[100%]">
          ...
          <Row className="font-poppins items-start ml-[3px] w-[93%]">
            <Sidebar2
              className="w-[18%]"
              onListMenuClick={handleNavigate93}
              onListMenuClick1={handleNavigate94}
            />
            <Column className="font-inter justify-start lg:ml-[10px] xl:ml-[13px] 2xl:ml-[15px] 3xl:ml-[18px] lg:mt-[19px] xl:mt-[24px] 2xl:mt-[27px] 3xl:mt-[32px] w-[80%]">
              ...
              <Row className="bg-gray_401 font-worksans items-start xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] lg:mt-[13px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[23px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius10 w-[42%]">
                ...
                <Column className="bg-light_blue_500 items-end justify-start 3xl:ml-[10px] lg:ml-[6px] xl:ml-[7px] 2xl:ml-[8px] mt-[3px] lg:p-[3px] 2xl:p-[4px] xl:p-[4px] 3xl:p-[5px] rounded-radius5 w-[29%]">
                  <Text className="columnsimulateddrone" variant="body12">
                    Simulated Drone Cloud
                  </Text>
                </Column>
                <Text
                  className="bg-light_blue_A700 lg:ml-[11px] xl:ml-[14px] 2xl:ml-[16px] 3xl:ml-[19px] mt-[3px] lg:pb-[12px] xl:pb-[15px] 2xl:pb-[17px] 3xl:pb-[21px] lg:pl-[16px] xl:pl-[20px] 2xl:pl-[23px] 3xl:pl-[28px] xl:pr-[10px] 2xl:pr-[11px] 3xl:pr-[13px] lg:pr-[8px] lg:pt-[4px] 2xl:pt-[5px] xl:pt-[5px] 3xl:pt-[6px] rowdata_collection_one"
                  variant="body12"
                >
                  Drone Services Map
                </Text>
              </Row>
              <Column className="font-poppins justify-start lg:mt-[16px] xl:mt-[20px] 2xl:mt-[22px] 3xl:mt-[27px] w-[96%]">
                <Column className="bg-white_A700 border border-blue_50 border-solid items-center justify-start lg:p-[12px] xl:p-[15px] 2xl:p-[17px] 3xl:p-[21px] rounded-radius12 shadow-bs8 w-[72%]">
                ...
                <Row className="items-start lg:mt-[24px] xl:mt-[30px] 2xl:mt-[33px] 3xl:mt-[40px] w-[100%]">
                  <Column className="bg-white_A700 border border-blue_50 border-solid justify-center lg:p-[11px] xl:p-[14px] 2xl:p-[16px] 3xl:p-[19px] rounded-radius12 shadow-bs8 w-[47%]">
                  ...
                  <Column className="bg-white_A700 border border-blue_50 border-solid justify-start lg:ml-[15px] xl:ml-[19px] 2xl:ml-[21px] 3xl:ml-[26px] xl:mt-[10px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[8px] 3xl:p-[11px] lg:p-[6px] xl:p-[8px] 2xl:p-[9px] rounded-radius12 shadow-bs8 w-[40%]">
                    ...
                    <Row className="bg-white_A700 border border-blue_50 border-solid items-center justify-end lg:ml-[10px] xl:ml-[13px] 2xl:ml-[15px] 3xl:ml-[18px] lg:mr-[18px] xl:mr-[22px] 2xl:mr-[25px] 3xl:mr-[30px] my-[4px] lg:p-[10px] xl:p-[13px] 2xl:p-[15px] 3xl:p-[18px] rounded-radius12 shadow-bs8 w-[89%]">
                  ...
                  <Img
                    ...
                    className="3xl:h-[10px] lg:h-[6px] xl:h-[8px] 2xl:h-[9px] 3xl:ml-[119px] lg:ml-[70px] xl:ml-[88px] 2xl:ml-[99px] xl:mt-[106px] 2xl:mt-[120px] 3xl:mt-[144px] lg:mt-[85px] w-[1%]"
                    alt="calendar"
                  />
                </Row>
              </Column>
...
export default AdminSimulatedCloudDPage;
