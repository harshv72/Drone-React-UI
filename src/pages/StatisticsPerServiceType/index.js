...
const StatisticsPerServiceTypePage = () => {
  ...
  return (
    <>
      <Column className="bg-white_A700 font-inter items-center justify-start mx-[auto] lg:pb-[259px] xl:pb-[324px] 2xl:pb-[365px] 3xl:pb-[438px] w-[100%]">
        <Column className="justify-start w-[100%]">
          ...
          <Row className="font-poppins items-start ml-[3px] w-[73%]">
            ...
            <div className="lg:mt-[39px] xl:mt-[49px] 2xl:mt-[56px] 3xl:mt-[67px] overflow-x-auto w-[71%]">
              <Column className="justify-start w-[100%]">
                ...
                <Column className="font-poppins justify-start mt-[4px] w-[100%]">
                  ...
                  <Column className="font-manrope justify-end lg:mt-[25px] xl:mt-[32px] 2xl:mt-[36px] 3xl:mt-[43px] lg:pt-[24px] xl:pt-[31px] 2xl:pt-[35px] 3xl:pt-[42px] w-[100%]">
                    <Column className="justify-start w-[100%]">
                      <Row className="items-start justify-between pr-[4px] pt-[4px] w-[100%]">
                        <Text className="title" variant="body4">
                          Flights Per Service Type: 4 avg
                        </Text>
                        <Img
                    ...
                    <Column className="bg-white_A700 font-dmsans items-center justify-start lg:p-[14px] xl:p-[18px] 2xl:p-[21px] 3xl:p-[25px] rounded-radius14 w-[76%]">
                      <Column className="items-center justify-start lg:mb-[18px] xl:mb-[23px] 2xl:mb-[26px] 3xl:mb-[31px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] w-[99%]">
                        <Stack className="lg:h-[127px] xl:h-[159px] 2xl:h-[179px] 3xl:h-[214px] w-[99%]">
                          <Stack className="absolute lg:h-[127px] xl:h-[159px] 2xl:h-[179px] 3xl:h-[214px] w-[100%]">
                            <Stack className="absolute lg:h-[127px] xl:h-[159px] 2xl:h-[179px] 3xl:h-[214px] w-[100%]">
                              <Img
                                src="images/img_frame48_150X581.svg"
                                className="FrameFortyEight"
                                alt="FrameFortyEight"
                              />
                              <div className="absolute bg-gradient3  lg:h-[124px] xl:h-[154px] 2xl:h-[174px] 3xl:h-[208px] inset-y-[0] left-[44%] my-[auto] rounded-radius10 w-[7%]"></div>
                            </Stack>
                            <Column
                              className="absolute bg-cover bg-repeat bottom-[4%] justify-end lg:p-[46px] xl:p-[57px] 2xl:p-[65px] 3xl:p-[78px] w-[100%]"
                              style={{
                                backgroundImage:
                                  "url('images/img_group470.png')",
                              }}
                            >
                              <div className="bg-deep_purple_A100 border-bw3 border-solid border-white_A700 xl:h-[10px] 2xl:h-[12px] 3xl:h-[14px] lg:h-[8px] lg:ml-[147px] xl:ml-[184px] 2xl:ml-[207px] 3xl:ml-[248px] mt-[1px] rounded-radius50 2xl:w-[11px] 3xl:w-[13px] lg:w-[7px] xl:w-[9px]"></div>
                            </Column>
                          </Stack>
                          <Column className="absolute justify-start right-[33%] top-[9%] w-[12%]">
                            <Text
...
export default StatisticsPerServiceTypePage;
